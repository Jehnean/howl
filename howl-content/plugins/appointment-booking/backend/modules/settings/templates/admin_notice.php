...
<div id=ab_admin_notice class=update-nag>
    <h3>Bookly</h3>
    <p><?php printf( __( 'Please do not forget to specify your purchase code in Bookly <a href="%s">settings</a>. Upon providing the code you will have access to free updates of Bookly. Updates may contain functionality improvements and important security fixes.', 'bookly' ), AB_Utils::escAdminUrl( AB_SettingsController::page_slug, array( 'type' => '_purchase_code' ) ) ) ?></p>
