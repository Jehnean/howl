...
<style type="text/css">
    ...
    .ab-next-step, .ab-mobile-next-step, .ab-mobile-prev-step, li.ab-step-tabs.active div,.ab-booking-form  .picker__frame, .ab-first-step .ab-week-days li label {background: <?php echo $color ?>!important;}
    ...
    input.ab-field-error, textarea.ab-field-error, div.ab-error select {border: 2px solid <?php echo $color ?>!important;}
</style>