...
class WP_Job_Manager_Claim_Listing {
    ...
    public function includes() {
        ...
        $this->shortcode = new WPJMCL_Shortcode();
        $this->checkout = new WPJMCL_Checkout();
        $this->orders = new WPJMCL_Orders();
        $this->wcpl = new WPJMCL_WC_Paid_Listings();
        $this->forms = new WPJMCL_Forms();
...
add_action( 'plugins_loaded', 'wpjmcl' );
