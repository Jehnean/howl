...
class WPJMCL_WC_Paid_Listings {
    ...
    public function __construct() {
        ...
        add_action( 'woocommerce_process_product_meta_job_package', array( $this, 'save_claimed_checkbox' ) );

        /**
         * Paid listing checkout process
         */
        add_filter( 'product_type_options', array( $this, 'add_claimable_listing_package_checkbox' ) );
        add_action( 'woocommerce_process_product_meta_job_package', array( $this, 'save_product_type_fields' ) );
        add_action( 'woocommerce_process_product_meta_job_package_subscription', array( $this, 'save_product_type_fields' ) );
    }
     ...
     */
    public function save_claimed_checkbox( $post_id ) {
     ...
     */
    public function add_claimable_listing_package_checkbox( $product_type_options ) {
     ...
     */
    public function save_product_type_fields( $post_id ) {
